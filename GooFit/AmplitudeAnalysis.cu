                                    ...
                                    if (bkgPhaseSpace) {
                                      ...
                                      if (bkgPdfHist) {
                                        ...
                                        */
                                        ...
                                        bkgHistosInt[0]->Scale(bkgTH2Mass->Integral());

                                        bkgHistosInt[1]->Scale(1.0/interpolationSum);
                                        bkgHistosInt[1]->Scale(bkgTH2Ang->Integral());

                                        bkgHistosInt[0]->Draw("LEGO");
                                        canvasM->SaveAs("./plots/massBkgIntHisto.png");
                                        canvasM->Clear();

                                        bkgTH2Mass->Draw("LEGO");
                                        canvasM->SaveAs("./plots/massBkgHistogram.png");
                                        canvasM->Clear();

                                        bkgHistosInt[0]->Draw("SURF3");
                                        bkgTH2Mass->Draw("same");
                                        canvasM->SaveAs("./plots/massBkgHistAndIntHist.png");
                                        canvasM->Clear();

                                        bkgHistosInt[1]->Draw("LEGO");
                                        canvasM->SaveAs("./plots/angBkgIntHisto.png");
                                        canvasM->Clear();

                                        bkgTH2[1].Draw("LEGO");
                                        canvasM->SaveAs("./plots/angBkgHistogram.png");
                                        canvasM->Clear();

                                        bkgHistosInt[1]->Draw("SURF3");
                                        bkgTH2[1].Draw("same");
                                        canvasM->SaveAs("./plots/angBkgHistAndIntHist.png");
                                        canvasM->Clear();
